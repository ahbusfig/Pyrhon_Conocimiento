...
'''
# Ordenar los atletas por nombre en orden ascendente
print(colored("Ordenar los atletas por nombre en orden ascendente", "green"))
print(colored(bio.sort_values(by='name').head(20), "yellow"))

# Ordenar los atletas por altura en orden descendente
# print(colored("Ordenar los atletas por altura en orden descendente", "green"))
# print(colored(bio.sort_values(by='height_cm', ascending=False).head(20), "yellow"))

# # Ordenar los atletas por peso en orden ascendente
# print(colored("Ordenar los atletas por peso en orden ascendente", "green"))
# print(colored(bio.sort_values(by='weight_kg').head(20), "yellow"))

# # Ordenar los atletas por fecha de nacimiento en orden ascendente
# print(colored("Ordenar los atletas por fecha de nacimiento en orden ascendente", "green"))
# print(colored(bio.sort_values(by='born_date').head(20), "yellow"))

# # Ordenar los atletas por ciudad de nacimiento en orden descendente
# print(colored("Ordenar los atletas por ciudad de nacimiento en orden descendente", "green"))
# print(colored(bio.sort_values(by='born_city', ascending=False).head(20), "yellow"))

# # Ordenar los atletas por nombre y luego por altura en orden ascendente
# print(colored("Ordenar los atletas por nombre y luego por altura en orden ascendente", "green"))
# print(colored(bio.sort_values(by=['name', 'height_cm']).head(20), "yellow"))

# # Ordenar los atletas por peso y luego por fecha de nacimiento en orden descendente
# print(colored("Ordenar los atletas por peso y luego por fecha de nacimiento en orden descendente", "green"))
# print(colored(bio.sort_values(by=['weight_kg', 'born_date'], ascending=[False, False]).head(20), "yellow"))